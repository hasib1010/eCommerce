    ...
    return (
        <div className="flex items-center justify-center min-h-screen bg-gradient-to-r from-blue-400 via-indigo-500 to-purple-600">
            <div className="w-full max-w-md p-8 bg-white rounded-lg shadow-lg">
                ...
                <button className="flex items-center text-3xl font-bold gap-2 border w-full justify-center mt-5 rounded-lg hover:shadow-lg" onClick={handleGoogle}>
                  <img className="w-20" src="https://yt3.googleusercontent.com/viNp17XpEF-AwWwOZSj_TvgobO1CGmUUgcTtQoAG40YaYctYMoUqaRup0rTxxxfQvWw3MvhXesw=s900-c-k-c0x00ffffff-no-rj" alt="" />  Login with google
                </button>
            </div>
        </div>
    );
